...
import { Search, LayoutGrid, List, MapPin, Trash2, Plus, Copy, AlertTriangle } from 'lucide-react';
                ...
                <div className="overflow-x-auto rounded-xl border border-gray-200">
                    <table className="w-full text-sm text-left text-gray-700">
                        <thead className="bg-gray-50 text-gray-500 font-bold border-b border-gray-200">
                            <tr><th className="p-4">Numéro</th><th className="p-4">Zone</th><th className="p-4">Prix</th><th className="p-4">Occupant</th><th className="p-4 text-right">Actions</th></tr>
                        </thead>
                        <tbody>
                            {filteredStalls.map(stall => (
